...
type Defs struct {
	...
	ReadResourceRequestParams         ERequestParams                    `json:"ReadResourceRequestParams"`
	...
	ResourceRequestParams             ERequestParams                    `json:"ResourceRequestParams"`
	...
	ResourceUpdatedNotificationParams ResourceUpdatedNotificationParams `json:"ResourceUpdatedNotificationParams"`
	...
	SubscribeRequestParams            ERequestParams                    `json:"SubscribeRequestParams"`
	Task                              Task                              `json:"Task"`
	...
	UnsubscribeRequestParams          ERequestParams                    `json:"UnsubscribeRequestParams"`
